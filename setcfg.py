...
if __name__ == "__main__":
	...
	config.set('ceph', 'backup_driver', 'cinder.backup.drivers.ceph')
	config.set('ceph', 'backup_ceph_user', 'cinder-backup')
	config.set('ceph', 'backup_ceph_conf', '/etc/ceph/ceph.conf')
	config.set('ceph', 'backup_ceph_chunk_size', '134217728')
	config.set('ceph', 'backup_ceph_pool', 'backups')
	config.set('ceph', 'backup_ceph_stripe_unit', '0')
	config.set('ceph', 'backup_ceph_stripe_count', '0')
	config.set('ceph', 'restore_discard_excess_bytes', 'true')
